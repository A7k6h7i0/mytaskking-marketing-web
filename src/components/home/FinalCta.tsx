  ...
  return (
    <section id="contact" className="scroll-mt-24 py-20 md:py-28">
      <div className="container-site section-pad">
        <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-accent via-[#ff5a3c] to-[#ff7a45] p-8 text-white sm:p-12 md:p-14">
          <div
          ...
          <div className="relative grid gap-8 lg:grid-cols-[1.3fr_0.7fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-3 font-display text-3xl font-bold sm:text-4xl md:text-5xl md:leading-[1.05]">
